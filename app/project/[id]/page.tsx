        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <Link className="block rounded-md border border-border bg-background/35 p-3 transition hover:bg-secondary" href={`/project/${project.id}/estrategia`}>
                Revisar estratégia e promessa ROMA
              </Link>
              <Link className="block rounded-md border border-border bg-background/35 p-3 transition hover:bg-secondary" href={`/project/${project.id}/conteudo`}>
                Finalizar CPLs e VSL
              </Link>
              <Link className="block rounded-md border border-border bg-background/35 p-3 transition hover:bg-secondary" href={`/project/${project.id}/funil`}>
